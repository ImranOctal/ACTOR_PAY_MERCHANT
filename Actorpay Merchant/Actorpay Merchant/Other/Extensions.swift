...
extension UITextField {
    ...
    func setError(_ string: String? = nil, show: Bool = true, triagleConst: CGFloat = -22, labelHeight: CGFloat = 25) {
        ...
        triagle.trailingAnchor.constraint(equalTo: container.trailingAnchor, constant: triagleConst).isActive = true
